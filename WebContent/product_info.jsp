...
<script type="text/javascript">
  function addCart() {
	 ...
	 // 将 获取到 商品数量  buyNum 和  商品的pid 都要传给服务端  购物侧servlet程序
	 
	 location.href ="${pageContext.request.contextPath}/cart?method=addCart&pid=${product.pid }&buyNum="+buyNum;
	 
	/*  ${pageContext.request.contextPath }/cart?pid=${product.pid }&buyNum=1 */
